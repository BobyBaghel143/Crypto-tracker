...
import {
  fetchCryptoById,
  fetchCryptoList,
} from "../Repository/CryptoRepository";
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 w-[80vw] mx-auto my-5 ">
      ...
      <div className="flex flex-col w-[80vw] mx-auto ">
        {coins.map((coin) => {
          return (
            <div
              key={coin.id}
              className="w-full bg-transparent flex items-center justify-between text-white font-semibold px-2 py-4"
            >
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <button
          onClick={() => setPage((page) => page + 1)}
          className="btn btn-secodary btn-wide text-white text-2xl"
        >
          Next
        </button>
      </div>
